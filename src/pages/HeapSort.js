...
// Heap Sort Algorithm
import heapFn from "./components/utils/algorithms/heapSortFn";
...
const HeapSort = () => {
	...
	const handleClick = async () => {
		if (arr.length !== 0) {
			...
			message.warning({
				content: "Heap Sort is Running ! Don't click any Button",
				key,
				duration: 0,
				style: {
					marginTop: "20vh",
			...
			setDisable(true);
			await heapFn(setArr, arr, time, setDisable);
